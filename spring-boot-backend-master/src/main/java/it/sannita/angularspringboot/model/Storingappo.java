...
/**
 * The persistent class for the storingappo database table.
 * 
 */
@Entity
@NamedQuery(name="Storingappo.findAll", query="SELECT s FROM Storingappo s")
public class Storingappo implements Serializable {
